...
*   [x] **Silent Payments (BIP 352):** Core integration with standard derivation paths (`m/352'/0'/0'/0'/0`).
*   [ ] **BIP 322 Support:** Architectural port defined and initial mock implementation completed.
